...
import { onCreateAction } from "../../../../redux/skills/action";
...
const ListHeader = ({ btnTitle }) => {
    ...
    return (
        <View style={styles.listHeaderContainer}>
            <ModalView onSave={() => { onCreateAction(), setVisible(false) }} visible={visible} setVisible={setVisible} modalTitle={"Add Skills"} />
